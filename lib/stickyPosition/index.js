...
var _default = function _default(ReactTable) {
      ...
      value: function getColumnsWithFixed(columns, parentIsfixed, parentIsLastFixed, parentIsFirstFixed) {
        ...
        return columns.map(function (column, index) {
          ...
          return _objectSpread({}, column, {
            ...
            headerClassName: (0, _classnames.default)(column.headerClassName, fixed && _styles.fixedClassName, columnIsLeftFixed && _styles.fixedLeftClassName, columnIsLeftFixed && customFixedLeftClassName, columnIsRightFixed && _styles.fixedRightClassName, columnIsRightFixed && customFixedRightClassName, (_parentIsLastFixed || parentIsLastFixed && isLastFixed) && _styles2.lastLeftFixedClassName, (_parentIsLastFixed || parentIsLastFixed && isLastFixed) && customLastLeftFixedClassName, (_parentIsFirstFixed || parentIsFirstFixed && isFirstFixed) && _styles2.lastRightFixedClassName, (_parentIsFirstFixed || parentIsFirstFixed && isFirstFixed) && customLastRightFixedClassName),
  ...
  ReactTableFixedColumns.propTypes = {
    ...
    customFixedLeftClassName: _propTypes.default.string,
    customFixedRightClassName: _propTypes.default.string,
    customLastLeftFixedClassName: _propTypes.default.string,
    customLastRightFixedClassName: _propTypes.default.string
  };
